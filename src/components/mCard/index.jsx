...
import './index.scss'; // 将原SCSS样式转换为CSS

const MCard = ({ width = 398, height = 200, title = "标题", children }) => {
    const [componentsUID, setComponentsUID] = useState(1);

    // 计算样式
    const calcWidthHeightStyle = useMemo(() => ({
        width: `${width}px`,
        height: `${height}px`
    }), [width, height]);

    // SVG路径计算
    const titleStorke = useMemo(() => {
        return `M165 0.5
    L165.707 -0.207107
    L165.414 -0.5
    H165
    ...
    useEffect(() => {
        setComponentsUID(`__${Math.floor(Math.random() * 100000)}`);
    }, []);

    return (
        <div className="m-card" style={calcWidthHeightStyle}>
            {/* 头部区域 */}
            <div className="m-card-hd">
                <div className="m-card-hd-bg">
                    <svg width={width} height="36" viewBox={`0 0 ${width} 36`} fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath={`url(#clip0_70_69244${componentsUID})`}>
                            ...
                            <mask id={`path-2-inside-1_70_69244${componentsUID}`} fill="white">
                                <path fillRule="evenodd" clipRule="evenodd" d={`M10 0.5H165L175 10.5H${width}V34.5H0V10.5L10 0.5Z`} />
                            </mask>
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                            ...
                            />
                            <g style={{ mixBlendMode: 'plus-lighter' }} clipPath={`url(#clip1_70_69244${componentsUID})`}>
                                <g style={{ mixBlendMode: 'plus-lighter' }} opacity="0.8">
                                    <ellipse
                                        cx="65"
                                        cy="2.16667"
                                ...
                                <g style={{ mixBlendMode: 'plus-lighter' }} opacity="0.54">
                                    <ellipse
                                        cx="23.2143"
                                        cy="2.16667"
                                        rx="23.2143"
                        ...
                        <defs>
                            ...
                            >
                                <stop stopColor="#35A8EB" stopOpacity="0.1" />
                                <stop offset="1" stopColor="#30DCFF" />
                            </linearGradient>
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop offset="0.0364889" stopColor="#35A8EB" stopOpacity="0.11" />
                                <stop offset="1" stopColor="#30C1FF" stopOpacity="0.27" />
                            </linearGradient>
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop stopColor="#35A8EB" stopOpacity="0" />
                                <stop offset="1" stopColor="#30DCFF" />
                            </linearGradient>
                            <radialGradient
                            ...
                            >
                                <stop stopColor="#B7EEFF" />
                                <stop offset="0.302515" stopColor="#9BE2FF" stopOpacity="0.76" />
                                <stop offset="1" stopColor="#6BD4FF" stopOpacity="0" />
                            </radialGradient>
                            <radialGradient
                            ...
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop offset="0.429792" stopColor="#35A8EB" stopOpacity="0" />
                                <stop offset="1" stopColor="#30C1FF" stopOpacity="0.27" />
                            </linearGradient>
                            <radialGradient
                ...
                <img className="m-card-hd-zs1" src="/src/assets/images/m-card/title-zs1.svg" alt="" />
                <div className="saoguang">
                    <img src="/src/assets/images/m-card/saoguang.svg" alt="" />
                </div>
                <div className="m-card-hd-title">{title}</div>
            </div>

            {/* 内容区域 */}
            <div className="m-card-bd" style={calcWidthHeightStyle}>
                <div className="m-card-bd-bg" style={calcWidthHeightStyle}>
                    <svg
                        width={width}
                        height={height}
                    ...
                    >
                        ...
                        <defs>
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop stopColor="#4FC5DD" />
                                <stop offset="1" stopColor="#05839D" stopOpacity="0" />
                            </linearGradient>
                        </defs>
                    </svg>
                    <img className="m-card-bd-bottom-left-arrow" src="/assets/images/m-card/content-bottom-left-arrow.svg" alt="" />
                    <img className="m-card-bd-bottom-right-arrow" src="/assets/images/m-card/content-bottom-right-arrow.svg" alt="" />
                    <img className="m-card-bd-middle-left-line" src="/assets/images/m-card/content-middle-line.svg" alt="" />
                    <img className="m-card-bd-middle-right-line" src="/assets/images/m-card/content-middle-line.svg" alt="" />
                </div>
                <div className="m-card-bd-content">
                    {children}
                </div>
            </div>
        </div>
